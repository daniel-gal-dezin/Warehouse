...
public:
    ...
    void setcompletedOrderId(int id); // TO DEFINE
    void setactiveOrderId(int id);    // TO DEFINE

    // added by us
    virtual bool getdone() = 0; // need to define
    void setdone(bool);
    virtual string volenteerType() = 0;
